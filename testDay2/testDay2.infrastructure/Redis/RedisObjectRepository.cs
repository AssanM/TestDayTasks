...
namespace testDay2.infrastructure.Redis;
...
public class RedisObjectRepository : IObjectRepository
{
    ...
    public event EventHandler<ObjectUpdated>? ObjectUpdated;
    ...
    public async Task UpdateAsync(MapObject updatedObject)
    {
        ...
        ObjectUpdated?.Invoke(this, new ObjectUpdated(existing, updatedObject));
    }
}
