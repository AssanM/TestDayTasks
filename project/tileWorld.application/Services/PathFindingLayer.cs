...
{
    private readonly ISurfaceLayer _enginelayer;

    public PathFindingLayer(ISurfaceLayer enginelayer) => _enginelayer = enginelayer;
        ...
        return await Task.Run(async () =>
        {
            ...
            while (openSet.Count > 0)
            {
                ...
                foreach (var neighbor in GetNeighbors(current))
                {
                    ...
                    if (tile != SurfaceType.Plain) continue;
