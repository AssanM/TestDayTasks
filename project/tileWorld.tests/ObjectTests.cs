...
{
    private readonly Mock<ObjectRepository> _mockService;
    private readonly ObjectsController _controller;
    public ObjectTests()
    {
        _mockService = new Mock<ObjectRepository>(MockBehavior.Strict, null!);
        _controller = new ObjectsController(_mockService.Object);
    }
    [Fact]
